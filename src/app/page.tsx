      ...
      <div className="w-full flex flex-col items-center gap-4 divide-y">
        ...
        <div className="w-full flex flex-col items-center gap-4 p-4">
          ...
          <RegularButton
            ...
            className="w-full p-2 bg-white text-slate-900 border border-slate-300" iconName="google"
          />
          <RegularButton
            variant="custom" type="button" title="Continue with Facebook"
            className="w-full p-2 bg-white text-slate-900 border border-slate-300" iconName="facebook"
          />
        </div>
      </div>
    </main>
